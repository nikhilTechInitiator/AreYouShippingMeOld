          ...
          GestureDetector(
            onTap: () async {
              ...
              var result = await Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (c, a1, a2) => SearchPage(language: widget.language,apiKey: widget.apiKey, searchPlaceHolder: widget.searchHint,),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ( widget.polygonPoints==null||IsUserInArea(_latLng?.latitude, _latLng?.longitude))&&loading == false?  GestureDetector(
...
showGoogleMapLocationPicker(
  ...
  final pickedLocation = await customPopup(MapScreen(apiKey: apiKey,pinWidget: pinWidget, appBarTitle: appBarTitle, searchHint: searchHint,polygonPoints:polygonPoints, addressTitle: addressTitle, confirmButtonText: confirmButtonText, language: language, confirmButtonColor: confirmButtonColor, pinColor: pinColor, confirmButtonTextColor: confirmButtonTextColor, addressPlaceHolder: addressPlaceHolder, initialLocation: initialLocation,));
